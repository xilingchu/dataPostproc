# pyright: reportUnusedVariable=false, reportInvalidTypeForm=false, reportAttributeAccessIssue=false, reportIndexIssue=false
...
def _readHDF(_fn=None, _var=None, _blockz=None, _blocky=None, _blockx=None):
    ...
    with h5py.File(_fn, 'r') as f:
        ...
        if dims == 1:
            ...
            raise Exception('The maximum dimension is 3.')
    return _var_out
